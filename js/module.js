...
vanilla_tilt__WEBPACK_IMPORTED_MODULE_0___default().init(document.querySelectorAll(".step__item"), {
  max: 15,
  speed: 900
});
vanilla_tilt__WEBPACK_IMPORTED_MODULE_0___default().init(document.querySelectorAll(".verticals__list li"), {
  max: 15,
  speed: 900
});
